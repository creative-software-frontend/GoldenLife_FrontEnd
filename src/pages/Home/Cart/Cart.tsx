...
export default function Cart() {
  ...
  const savePriceChange = (id: number, merchantPrice: number, maxPrice: number) => {
  ...
  const subtotalValue = getSubtotal(); // Member Price Sum
  const customerTotalValue = getCustomerTotal(); // Customer Price Sum
  const totalAdjustment = customerTotalValue - subtotalValue;
          ...
          <div className="p-5 border-b border-gray-100 flex items-center justify-between bg-white shadow-sm z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium">{totalItemsCount} Items added</p>
              </div>
            </div>
                      ...
                      <div className="flex-1 flex flex-col justify-between py-0.5">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {editingId === item.id ? (
                              <div className="flex items-center gap-1.5 animate-in slide-in-from-right-2 duration-200">
                                ...
                                />
                                <button
                                  onClick={() => savePriceChange(item.id, merchantPrice, item.original_regular_price || 0)}
                        ...
                        <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-50">
                          ...
                          <div className="flex items-center border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm h-8">
                            ...
                            <span className="w-8 text-center text-xs font-bold text-gray-700">{itemQuantity}</span>
                            <button
                              onClick={() => updateQuantity(item.id, 1)}
            ...
            <div className="p-6 border-t border-gray-100 bg-white shadow-[0_-10px_30px_rgba(0,0,0,0.03)] space-y-5 z-20">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center text-xs font-bold text-gray-400">
                  ...
                  <span>৳{formatBDT(subtotalValue)}</span>
                </div>

                <div className="flex justify-between items-center text-xs font-bold text-gray-400">
                  <span className="uppercase tracking-widest">Total Adjustment</span>
                  <span className={totalAdjustment >= 0 ? "text-emerald-600" : "text-rose-500"}>
                ...
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-2xl font-black text-gray-900 tracking-tight">৳{formatBDT(customerTotalValue)}</span>
                </div>
              </div>
              ...
              >
                ...
                <span>৳{formatBDT(customerTotalValue)}</span>
              </Button>
            </div>
          )}
