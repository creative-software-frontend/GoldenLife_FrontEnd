        ...
        >
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <a href="mailto:info@goldenlife.vercel.app" className="inline-block bg-white border border-gray-200 text-gray-900 px-6 py-3 rounded-lg font-medium hover:border-[#FF9100] hover:text-[#FF9100] transition-colors">
                Contact Support
              </a>
            </div>
          </div>
